...
if __name__ == '__main__':
    filename = 'datasets/cars-data.csv'  # Which file you're reading from
    outname = 'datasets/processed-cars-data.csv'  # Name of the file to write to (erases if already exists)
